...
class LetterMoveCitizenController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('transactions.letters.movecitizen.form', compact('citizen','informations','position'));
    }
    ...
    public function store(Request $request)
    {
        if( Auth::user()->roles == 'god' || Auth::user()->roles == 'admin'){
            ...
            $validatedData = $request->validate([
                ...
                'village_to' => 'required',
                'sub_districts_to' => 'required',
                'districts_to' => 'required',
            ...
            LetterMoveCitizen::create($validatedData);
    ...
    public function update(Request $request, $uuid)
    {
        if( Auth::user()->roles == 'god' || Auth::user()->roles == 'admin'){
            ...
            if ($validatedData) {
                ...
                $letters = LetterMoveCitizen::where('uuid', $uuid)->first()->update($validatedData);
            }
