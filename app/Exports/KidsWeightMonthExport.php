...
class KidsWeightMonthExport implements FromView
{
    public $data;
    // public $nik;
    // public $name;
    ...
    // ,$nik,$name,$weight,$height,$imdbSelected,$methodMeasureSelected,$vitaminSelected,$kmsSelected,$imunitationSelected,$boosterSelected,$headWidth,$e1Selected,
    ...
    */
    ...
    {
        return view('transactions.kidsweightmonth.exportKidsWeightMonth', [
            'datas' => $this->datas,
            // 'nik' => $this->nik,
            // 'name' => $this->name,
            // 'weight' => $this->weight,
