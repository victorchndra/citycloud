                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="date" readonly class="form-control @error('date_birth') is-invalid @enderror" name="date_birth" id="date" required value="{{ date('YYYY-MM-DD', strtotime(Str::limit($c->date_birth, 10, '')))}}">
                        </div>
                        </div>
                    </div>
                </div>
