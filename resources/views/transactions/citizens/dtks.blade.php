                            ...
                            <div class="modal-content">
                                <form class="form-sample" action="/citizens" id="search_form">
                                                    ...
                                                    <div class="col-sm-9 row">
                                                        <div class="col-sm-4 birth-input">
                                                            <input type="number" name="date_birth" id="date_birth"
                                                                class="form-control col-md-7 input-min" value="0">
                                                        </div>
                                                        <div class="col-sm-1">
                                                            <div class="col-form-label mySeparator">-</div>
                                                        </div>
                                                        <div class="col-sm-4 birth-input">
                                                            <input type="number" name="date_birth2" id="date_birth2"
                                                                class="form-control col-md-7 input-max" value="120">
                                                        </div>
                                                        ...
                                                        <div class="range-input">
                                                            <input type="range" class="range-min" min="0"
                                                                max="120" value="0" class="form-control">
                                                            <input type="range" class="range-max" min="0"
                                                                max="120" value="120" class="form-control">
                                                        </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="place_birth" id="place_birth" class="form-control">
                                                            ...
                                                            @foreach ($place_births as $place_birth)
                                                                <option value="{{ $place_birth->place_birth }}"
                                                                    @if ($place_birthSelected == $place_birth->place_birth) {{ 'selected' }} @endif>
                                                                    {{ $place_birth->place_birth }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="religion" id="religion" class="form-control">
                                                            ...
                                                            @foreach ($religions as $religion)
                                                                <option value="{{ $religion->religion }}"
                                                                    @if ($religionSelected == $religion->religion) {{ 'selected' }} @endif>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="family_status" id="family_status"
                                                            ...
                                                            @foreach ($family_statuses as $family_status)
                                                                <option value="{{ $family_status->family_status }}"
                                                                    @if ($family_statusSelected == $family_status->family_status) {{ 'selected' }} @endif>
                                                                    {{ $family_status->family_status }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="job" id="job" class="form-control">
                                                            ...
                                                            @foreach ($jobs as $job)
                                                                <option value="{{ $job->job }}"
                                                                    @if ($jobSelected == $job->job) {{ 'selected' }} @endif>
                                                                    {{ $job->job }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="row">
                                                        ...
                                                        <select name="marriage" id="marriage" class="form-control">
                                                            ...
                                                            @foreach ($marriages as $marriage)
                                                                <option value="{{ $marriage->marriage }}"
                                                                    @if ($marriageSelected == $marriage->marriage) {{ 'selected' }} @endif>
                                                                    {{ $marriage->marriage }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="last_education" id="last_education"
                                                            ...
                                                            @foreach ($last_educations as $last_education)
                                                                <option value="{{ $last_education->last_education }}"
                                                                    @if ($last_educationSelected == $last_education->last_education) {{ 'selected' }} @endif>
                                                                    {{ $last_education->last_education }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="health_assurance" id="health_assurance"
                                                            class="form-control">
                                                            <option value="">Semua Asuransi</option>
                                                            @foreach ($health_assurances as $health_assurance)
                                                                <option
                                                                    value="{{ $health_assurance->health_assurance }}"
                                                                    @if ($healthAssurancesSelected == $health_assurance->health_assurance) {{ 'selected' }} @endif>
                                                                    {{ $health_assurance->health_assurance }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="disability" id="disability" class="form-control">
                                                            ...
                                                            @foreach ($disabilitys as $disability)
                                                                <option value="{{ $disability->disability }}"
                                                                    @if ($disabilitySelected == $disability->disability) {{ 'selected' }} @endif>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="rt" id="rt" class="form-control">
                                                            ...
                                                            @foreach ($rts as $rt)
                                                                <option value="{{ $rt->rt }}"
                                                                    @if ($rtSelected == $rt->rt) {{ 'selected' }} @endif>
                                                                    {{ $rt->rt }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="rw" id="rw" class="form-control">
                                                            ...
                                                            @foreach ($rws as $rw)
                                                                <option value="{{ $rw->rw }}"
                                                                    @if ($rwSelected == $rw->rw) {{ 'selected' }} @endif>
                                                                    {{ $rw->rw }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="row">
                                                        ...
                                                        <select name="village" id="village" class="form-control">
                                                            @foreach ($villages as $village)
                                                                <option value="{{ $village->village }}"
                                                                    @if ($villageSelected == $village->village) {{ 'selected' }} @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="sub_districts" id="sub_districts"
                                                            class="form-control">
                                                            @foreach ($sub_districtses as $sub_districts)
                                                                <option value="{{ $sub_districts->sub_districts }}"
                                                                    @if ($sub_districtSelected == $sub_districts->sub_districts) {{ 'selected' }} @endif>
                                                                    {{ $sub_districts->sub_districts }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="districts" id="districts" class="form-control">
                                                            @foreach ($districtses as $districts)
                                                                <option value="{{ $districts->districts }}"
                                                                    @if ($districtsSelected == $districts->districts) {{ 'selected' }} @endif>
                                                        ...
                                                        <select name="province" id="province" class="form-control">
                                                            @foreach ($provinces as $province)
                                                                <option value="{{ $province->province }}"
                                                                    @if ($provinceSelected == $province->province) {{ 'selected' }} @endif>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="vaccine_1" id="vaccine_1" class="form-control">
                                                            @foreach ($vaccine1s as $vaccine_1)
                                                                <option value="{{ $vaccine_1->vaccine_1 }}"
                                                                    @if ($vaccine1Selected == $vaccine_1->vaccine_1) {{ 'selected' }} @endif>
                                                                    {{ $vaccine_1->vaccine_1 }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="vaccine_2" id="vaccine_2" class="form-control">
                                                            @foreach ($vaccine1s as $vaccine_2)
                                                                <option value="{{ $vaccine_2->vaccine_2 }}"
                                                                    @if ($vaccine1Selected == $vaccine_2->vaccine_2) {{ 'selected' }} @endif>
                                                                    {{ $vaccine_2->vaccine_2 }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="vaccine_3" id="vaccine_3" class="form-control">
                                                            @foreach ($vaccine1s as $vaccine_3)
                                                                <option value="{{ $vaccine_3->vaccine_3 }}"
                                                                    @if ($vaccine1Selected == $vaccine_3->vaccine_3) {{ 'selected' }} @endif>
                                                                    {{ $vaccine_3->vaccine_3 }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="dtks" id="dtks" class="form-control">
                                                            ...
                                                            @foreach ($dtkses as $dtks)
                                                                <option value="{{ $dtks->dtks }}"
                                                                    @if ($dtksSelected == $dtks->dtks) {{ 'selected' }} @endif>
                                                                    {{ $dtks->dtks }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" onclick="form_submit()"
                                            data-bs-dismiss="modal">Cari
                                            Data</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                @foreach ($datas as $key => $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="d-block mb-1"><b>TTL : </b>
                                                <span>{{ $data->place_birth ?? '-' }},
                                                    {!! $data->date_birth !!}
                                                    @php
                                        ...
                                        @endphp <b>({{ $y }} Tahun {{ $m }} Bulan {{ $d }} hari)</b></span></span>
                                            ...
                                            <span class="d-block mb-1"><b>Alamat : </b>
                                                <span>{{ $data->address ?? '-' }} <b>RT :
                                                    </b>{{ $data->rt ?? '-' }}<b> RW : </b>
                                                    {{ $data->rw ?? '-' }}</span></span>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a href="/citizens/{{ $data->uuid }}/show"
                                                            class="dropdown-item"><i
                                                                class="mdi mdi-account-card-details"></i> Lihat KK</a>
                                                        <div class="dropdown-divider"></div>

                                                        <form action="/dtks/{{ $data->uuid }}">
                                                            @csrf
                                                            <button class="dropdown-item" type="submit"
                                                                onclick="return confirm('Hapus data dan pindahkan ke penduduk aktif?')">Hapus
                                                                dari DTKS</button>
                                                        </form>

                                                        <form class="d-none invisible"
                                                            action="/citizens/destroy/{{ $data->uuid }}"
                                                            method="POST">
                                                            @csrf
