        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Multiple Surat Keterangan Hilang you can use</p>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Surat Keterangan Hilang</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                @foreach ($citizen as $c)
                                    <form class="form-sample" action="/letters-missing/{{ $c->uuid }}"
                                        method="POST">
                                        @method('put')
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <input type="text" name="missing_item"
                                                    class="form-control @error('missing_item') is-invalid @enderror"
                                                    placeholder="cth: 01/01/2022" required
                                                    value="{{ $c->missing_item }}" />
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" name="on_behalf"
                                                    class="form-control @error('on_behalf') is-invalid @enderror"
                                                    placeholder="cth: 01/01/2022" required
                                                    value="{{ $c->on_behalf }}" />
