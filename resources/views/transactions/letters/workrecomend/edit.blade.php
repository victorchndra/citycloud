            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form class="form-sample" action="/letters-job/{{ $c->uuid }}" method="POST">
                            @method('put')
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="place_job"
                                                ...
                                                placeholder="Pekerjaan Anda" value="{{ $information->place_job }}">
                                            @endforeach
                                        </div>
