    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Surat Rekomendasi Kerja</h3>
                <p class="text-subtitle text-muted">Multiple Surat Keterangan Rekomendasi you can use</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/list">Surat</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Surat Rekomendasi Kerja</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Surat Rekomendasi Kerja</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                        @if ( Auth::user()->roles == 'god' || Auth::user()->roles == 'admin')
                            <form class="form form-horizontal" action="/letters-job" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="apply_job"
                                                class="form-control @error('apply_job') is-invalid @enderror"
                                                placeholder="Pekerjaan">
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <label>Nama Perusahaan</label>
                                            <input type="text" name="place_job"
                                                class="form-control @error('place_job') is-invalid @enderror"
