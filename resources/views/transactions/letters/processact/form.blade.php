            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Surat Keterangan Akte Kelahiran Dalam Pengurusan</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                        @if ( Auth::user()->roles == 'god' || Auth::user()->roles == 'admin')
                            <form class="form form-horizontal" action="/letters-processact" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label>Tempat pengurusan</label>
                                            <input type="text" name="process_address" class="form-control @error('process_address') is-invalid @enderror" placeholder="Contoh : Dinas Catatan Sipil" required value="{{ old('process_address') }}"/>
