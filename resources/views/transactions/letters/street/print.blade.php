    ...
    <section class="pagebreak">
        ...
        <table align="center" width="600" style="line-height: 1.5;">
            <tr>
                <td class="justify">
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    Bahwa benar yang bersangkutan adalah warga masyarakat Desa {{ $informations->village_name }},
                    yang
        ...
        <div style="line-height: 1; margin-top: 10px;">
            <table align="center" width="540">
                <tr>
                    ...
                    <td width="2">: </td>
                    <td>{{ \Carbon\Carbon::parse($data->dates_go)->translatedFormat('d M Y') }}</td>
                </tr>
                <tr>
                    <td width="180"><span style="display:inline-block; width: 35 px;"></span>Alamat Yang Dituju</td>
                    <td width="2">: </td>
                    <td>{{ $data->address_go }}</td>
                </tr>
                <tr>
        ...
        <table align="center" width="600" style="line-height: 1.5;">
            <tr>
                <td class="justify">
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    Demikianlah surat keterangan jalan ini dibuat untuk dapat dipergunakan
