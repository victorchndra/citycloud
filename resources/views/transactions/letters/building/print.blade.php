...
<html class="no-js">
    ...
    <section class="pagebreak">
        ...
        <tr>
            <td>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Yang bertanda tangan dibawah ini :
            </td>
        </tr>
    </table>
    ...
    <div style="line-height: 1; margin-top: 10px;">
        <table align="center" width="540">
            ...
            <tr>
                <td width="180"><span style="display:inline-block; width: 35 px;"></span>Selaku Pemilik Bangunan</td>
                <td width="2">: </td>
                <td>{{ $data->building_owner }}</td>
            </tr>

            <tr>
                <td width="180"><span style="display:inline-block; width: 35 px;"></span>Terletak di</td>
                <td width="2">: </td>
                <td>{{$data->place_build}}</td>
            </tr>
            <tr>
                <td width="180"><span style="display:inline-block; width: 35 px;"></span>Dipergunakan Sebagai</td>
                <td width="2">: </td>
                <td>{{$data->use_build}}</td>
            </tr>
            <tr>
                <td width="180"><span style="display:inline-block; width: 35 px;"></span>Dengan Bukti Atas Penguasaan Tanah</td>
                <td width="2">: </td>
                <td>{{$data->proof_mastery}}</td>
            </tr>
        ...
        <tr>
            <td class="justify">
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Maka dengan ini menyatakan sebenarnya bahwa : <br/>
                <p style="text-align: justify;">1. Saya bertanggung jawab penuh terhadap pembangunan di lokasi tersebut baik
                    menyangkut kekuatan kontruksi,
                    kekokohan dan kualitas bangunan serta keselamatan umum dilingkungan sekitarnya dari kegagalan konstruksi; <br/>
                    2. Segala sesuatu yang timbul akibat pembangunan tersebut, adalah merupakan tanggung jawab saya sepenuhnya, baik
                    dari segi hukum maupun aspek teknik 
                </p>
                    
                Demikianlah {{ $data->letter_name }} ini saya buat tanpa ada paksaan dan tekanan dari pihak manapun juga, dibuat 
                sebagai kelengkapan persyaratan guna proses perizinan bangunan.
            </td>
        </tr>
    </table>
