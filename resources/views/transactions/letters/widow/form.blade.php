    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Surat Keterangan Janda/Duda</h3>
                <p class="text-subtitle text-muted">Multiple Surat Keterangan Janda/Duda you can use</p>
            </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Surat Keterangan Janda/Duda</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                        @if ( Auth::user()->roles == 'god' || Auth::user()->roles == 'admin')
                            <form class="form form-horizontal" action="/letters-widow" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
