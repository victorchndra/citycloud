    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Multiple Surat Keterangan Kematian you can use</p>
            </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Surat Keterangan Kematian</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                        @foreach ($citizen as $c)
                        <form class="form-sample" action="/letters-death/{{ $c->uuid }}" method="POST">
                            @method('put')
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" name="letter_index"
                                                ...
                                                placeholder="No Surat" value="{{ old('letter_index', $information->letter_index)}}">
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="date" name="death_date"
                                                ...
                                                placeholder="Tanggal Meninggal" value="{{ old('death_date', $c->death_date)}}">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="time" name="death_time"
                                                ...
                                                placeholder="Waktu Meninggal" value="{{ old('death_time', $c->death_time)}}">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="death_place"
                                                ...
                                                placeholder="Tempat Meninggal" value="{{ old('death_place', $c->death_place) }}">
                                        </div>


                                        <div class="col-md-12 form-group">
                                            <label>Tgl Surat</label>
                                            <input type="date" class="form-control @error('letter_date') is-invalid @enderror" name="letter_date" id="date" required value="{{ old('letter_date', $c->letter_date) }}">
                                        </div>
