            ...
            <div class="card-body">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                                    ...
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-streetgoods/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-processktp/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-collegedispensation/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-processact/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-inheritance/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <tr>
                            <td>42</td>
                            <td>Surat Keterangan Kepemilikan Tanah</td>
                            <td>
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-landownership/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <tr>
                         ...
                         <tr>
                           ...
                           <tr>
                            <td>46</td>
                            <td>Surat Keterangan Jual Beli Tanah</td>
                            <td>
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-land-transaction/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
                           ...
                           <tr>
                            <td>49</td>
                            <td>Surat Keterangan Menikah</td>
                            <td>
                                    <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown">Aksi</button>
                                            <div class="dropdown-menu">
                                                <a href="/letters-marriage/create"
                                                    class="dropdown-item"><i class="mdi mdi-tooltip-edit"></i> Buat Surat</a>
                                            </div>
                                        </div>
                                    </div>
