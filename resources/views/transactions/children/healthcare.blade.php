                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- Info Button --}}
                                        <button class="dropdown-item" data-bs-toggle="modal" data-mname="{{ strtoupper($data->mother_name) }}" data-fname="{{ strtoupper($data->father_name) }}" data-address="{{ strtoupper($data->address) }}" data-weight="{{ isset($data->children->weight) ? $data->children->weight : '' }}" data-height="{{ isset($data->children->height) ? $data->children->height : '' }}" data-numofchild="{{ isset($data->children->num_of_child) ? $data->children->num_of_child : '' }}" data-nik="{{ $data->nik }}" data-bpjs="{{ isset($data->children->bpjs) ? $data->children->bpjs : '' }}" onclick="
